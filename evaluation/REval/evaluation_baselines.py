...
class EvaluationOrchestrator:
    ...
    def run_evaluation(self):
        ...
        for task_name in self.task_names:
            ...
            # valid_prompts = valid_prompts[:10]
            # valid_contexts = valid_contexts[:10]
            processed_responses = []
            raw_responses = []
...
class Coverage(Task):
    ...
    def _get_sampling_params(self):
        return SamplingParams(temperature=0.0, repetition_penalty=1.0, max_tokens=8192,)
